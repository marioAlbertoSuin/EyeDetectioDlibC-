...
public:
	...
	HibridMedianfilter(HibridMedianfilter& src);
	//PROMISE: Copy Constructor for medianfilter

	HibridMedianfilter& operator=(const HibridMedianfilter& src);
